...
//Kontrolleri jonka kautta näytetään, lisätään ja poistetaan tapahtumia.
//Käytetään myös kun tehdään elokuvavalintoja tapahtumalle.
...
//  Metodi joka hakee ryhmän käyttäjätunnuksen  
